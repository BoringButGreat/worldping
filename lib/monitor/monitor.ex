defmodule Worldping.Monitor do
  ...
  """
  def http(host \\ "www.raintank.io", port \\ "80", path \\ "/", timeout \\ 5, method \\ "GET", expectRegex \\ "", collector_ids \\ [1, 2, 3, 4], collector_tags \\ [], enabled \\ true, frequency \\ 120, health_steps \\ 3, health_collectors \\ 3, health_notification_enabled \\ true, health_notification_email \\ "")
  def http(host, port, path, timeout, method, expectRegex, collector_ids, collector_tags, enabled, frequency, health_steps, health_collectors, health_notification_enabled, health_notification_email) do
    ...
    monitor_spec(1, settings, collector_ids, collector_tags, enabled, frequency, health_settings)
  end

  @doc """
  Create a JSON specification for an https monitor based on the given parameters
  """
  def https(host \\ "www.raintank.io", port \\ "443", path \\ "/", timeout \\ 5, method \\ "GET", expectRegex \\ "", validateCert \\ true, collector_ids \\ [1, 2, 3, 4], collector_tags \\ [], enabled \\ true, frequency \\ 120, health_steps \\ 3, health_collectors \\ 3, health_notification_enabled \\ true, health_notification_email \\ "")
  def https(host, port, path, timeout, method, expectRegex, validateCert, collector_ids, collector_tags, enabled, frequency, health_steps, health_collectors, health_notification_enabled, health_notification_email) do
    ...
    health_settings = health_settings_spec(health_steps, health_collectors, health_notification_enabled, health_notification_email)
    monitor_spec(2, settings, collector_ids, collector_tags, enabled, frequency, health_settings)
  end

  @doc """
  Create a JSON specification for a ping monitor based on the given parameters
  """
  def ping(hostname \\ "www.raintank.io", timeout \\ 5, collector_ids \\ [1, 2, 3, 4], collector_tags \\ [], enabled \\ true, frequency \\ 120, health_steps \\ 3, health_collectors \\ 3, health_notification_enabled \\ true, health_notification_email \\ "")
  def ping(hostname, timeout, collector_ids, collector_tags, enabled, frequency, health_steps, health_collectors, health_notification_enabled, health_notification_email) do
    ...
    health_settings = health_settings_spec(health_steps, health_collectors, health_notification_enabled, health_notification_email)
    monitor_spec(3, settings, collector_ids, collector_tags, enabled, frequency, health_settings)
  end

  @doc """
  Create a JSON specification for a DNS monitor based on the given parameters
  """
  def dns(name \\ "raintank.io", type \\ "A", protocol \\ "udp", timeout \\ 5, collector_ids \\ [1, 2, 3, 4], collector_tags \\ [], enabled \\ true, frequency \\ 120, health_steps \\ 3, health_collectors \\ 3, health_notification_enabled \\ true, health_notification_email \\ "")
  def dns(name, type, protocol, timeout, collector_ids, collector_tags, enabled, frequency, health_steps, health_collectors, health_notification_enabled, health_notification_email) do
    ...
    health_settings = health_settings_spec(health_steps, health_collectors, health_notification_enabled, health_notification_email)
    monitor_spec(4, settings, collector_ids, collector_tags, enabled, frequency, health_settings)
  end
  ...
  defp monitor_spec(monitor_type_id, settings, collector_ids, collector_tags, enabled, frequency, health_settings) do
    %{
